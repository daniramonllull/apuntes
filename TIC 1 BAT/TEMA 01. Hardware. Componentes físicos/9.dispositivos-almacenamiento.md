...
Estas nuevas unidades de almacenamiento ya no tienen la forma tradicional de un disco duro. Se trata de un nuevo formato de almacenamiento, más compacto y que se puede conectar directamente a la placa sin necesidad de cables, a través de una ranura especial.
...
- Video de alta definición, 3D y sonido envolvente
- Capacidad de 25 a 33,4 GB pro capa.
- El rayo láser que utiliza para ser leído es de color azul.
...
Los reproductores / grabadores de Blu-ray suelen ser compatibles con CD y DVD.
